...
const ManagerAnalytics = () => {
 ...
 <div>
 <h1 className="text-2xl font-bold text-theme-text tracking-tight">System Analytics</h1>
 <p className="text-theme-text-sec dark:text-[#A1A1AA] text-sm mt-1">Deep dive into incident trends and root cause categories.</p>
 </div>
 </motion.div>

 <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
 {/* Severity Distribution */}
 <motion.div variants={itemVariants} className="bg-theme-card backdrop-blur-xl border border-theme-border dark:border-[#27272A] shadow-xl p-8 rounded-[2rem] flex flex-col h-[420px]">
 <div className="flex justify-between items-center mb-8">
 <h3 className="font-bold text-lg text-theme-text tracking-tight">Severity Distribution</h3>
 <div className="p-2 bg-theme-surface dark:bg-[#18181B] border border-theme-border dark:border-[#27272A] rounded-lg">
 <PieChartIcon className="h-4 w-4 text-theme-text-sec dark:text-[#A1A1AA]"/>
 </div>
 </div>
 ...
 <motion.div variants={itemVariants} className="bg-theme-card backdrop-blur-xl border border-theme-border dark:border-[#27272A] shadow-xl p-8 rounded-[2rem] flex flex-col h-[420px]">
 <div className="flex justify-between items-center mb-8">
 <h3 className="font-bold text-lg text-theme-text tracking-tight">Common Root Causes</h3>
 <div className="p-2 bg-theme-surface dark:bg-[#18181B] border border-theme-border dark:border-[#27272A] rounded-lg">
 <BarChart2 className="h-4 w-4 text-theme-text-sec dark:text-[#A1A1AA]"/>
 </div>
 </div>
 <div className="flex-1 min-h-0">
 <ResponsiveContainer width="100%"height="100%">
