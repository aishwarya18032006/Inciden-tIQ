...
const LoginPage = () => {
 ...
 >
 <div className="mb-8">
 <h2 className={`text-3xl font-bold tracking-tight mb-2 text-theme-text dark:text-white`}>Welcome back</h2>
 <p className="text-theme-text-sec">Sign in to access your intelligence dashboard.</p>
 </div>

 {/* Segmented Control / Tabs */}
 <div className={`flex relative rounded-xl p-1 mb-8 bg-theme-bg`}>
 <div className="absolute left-1 top-1 bottom-1 w-[calc(50%-4px)] bg-theme-card dark:bg-[#18181B] rounded-lg shadow-sm border border-theme-border dark:border-[#3F3F46] z-0 transition-transform duration-300 ease-in-out"/>
 ...
 <Link to="/register"className={`flex-1 relative z-10 py-2.5 text-sm font-medium text-center rounded-lg transition-colors text-theme-text-sec hover:text-theme-text`}>
 Register
 </Link>
 </div>
 ...
 className={`w-full rounded-xl px-4 py-3.5 focus:outline-none focus:ring-2 transition-all bg-theme-card border border-theme-border text-theme-text placeholder-theme-text-sec focus:ring-blue-600/20 dark:focus:ring-[#A855F7]/50 focus:border-blue-600 dark:focus:border-[#A855F7] shadow-sm`}
 ...
 <input type="checkbox"id="remember"className={`rounded w-4 h-4 cursor-pointer text-blue-600 dark:text-[#A855F7] border-theme-border bg-theme-card`} />
 <label htmlFor="remember"className={`text-sm cursor-pointer text-theme-text-sec`}>Remember this device</label>
 </div>
 
 <button 
 type="submit"
 disabled={loading}
 className={`w-full mt-6 font-bold rounded-xl px-4 py-3.5 flex items-center justify-center gap-2 transition-all disabled:opacity-70 disabled:cursor-not-allowed group text-white shadow-lg bg-blue-600 hover:bg-blue-700 shadow-blue-600/20 dark:bg-gradient-to-r dark:from-[#A855F7] dark:to-[#8B5CF6] dark:hover:brightness-110 dark:shadow-[#A855F7]/25`}
 >
