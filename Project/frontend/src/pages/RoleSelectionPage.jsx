...
const RoleSelectionPage = () => {
 ...
 return (
 <div className="min-h-screen w-full transition-colors duration-500 flex flex-col items-center justify-center cloud-bg text-theme-text relative overflow-hidden py-12 px-6">
 ...
 <button 
 onClick={logout}
 className="px-4 py-2 bg-theme-card border border-theme-border text-theme-text-sec hover:text-red-500 hover:bg-red-50 rounded-full transition-colors shadow-sm font-bold text-[13px] flex items-center gap-2"
 >
 ...
 <h1 className="text-4xl lg:text-5xl font-black tracking-tight mb-4 text-theme-text ">Choose Your Workspace</h1>
 <p className="text-lg max-w-xl text-theme-text-sec ">Select how you want to use IncidentIQ for this session.</p>
 </motion.div>
 ...
 className="group relative w-full rounded-[2.5rem] p-10 shadow-xl transition-all duration-300 hover:scale-[1.02] flex flex-col bg-theme-card backdrop-blur-2xl border border-theme-border hover:shadow-[0_20px_50px_rgba(37,99,235,0.15)]"
 >
 ...
 <h2 className="text-3xl font-black tracking-tight mb-3 text-theme-text group-hover:text-blue-600 transition-colors">Developer</h2>
 <p className="text-[15px] leading-relaxed mb-8 text-theme-text-sec ">
 ...
 className="w-full font-bold rounded-full px-6 py-4 flex items-center justify-center gap-2 transition-all disabled:opacity-70 disabled:cursor-not-allowed group/btn mt-auto relative z-10 bg-theme-surface text-theme-text-sec group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-indigo-600 group-hover:text-white group-hover:shadow-lg group-hover:shadow-blue-500/30"
 >
 ...
 <motion.div 
 variants={itemVariants}
 className="group relative w-full rounded-[2.5rem] p-10 shadow-xl transition-all duration-300 hover:scale-[1.02] flex flex-col bg-theme-card backdrop-blur-2xl border border-theme-border hover:shadow-[0_20px_50px_rgba(6,182,212,0.15)]"
 >
 ...
 <h2 className="text-3xl font-black tracking-tight mb-3 text-theme-text group-hover:text-cyan-600 transition-colors">IT Manager</h2>
 <p className="text-[15px] leading-relaxed mb-8 text-theme-text-sec ">
