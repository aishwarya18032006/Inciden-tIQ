...
const Sidebar = () => {
 ...
 <div className="flex-1 bg-theme-card backdrop-blur-xl border border-theme-border dark:border-[#27272A] shadow-2xl rounded-[2rem] flex flex-col overflow-hidden">
 
 {/* Logo / Branding */}
 <div className="h-20 flex items-center justify-center md:justify-start md:px-6 border-b border-theme-border dark:border-[#27272A]/50 bg-theme-card dark:bg-black/20">
 ...
 <span className="font-bold tracking-tight text-theme-text hidden md:block">IncidentIQ</span>
 </Link>
 </div>

 {/* Links */}
 <div className="flex-1 py-6 px-3 flex flex-col gap-1 overflow-y-auto scrollbar-hide">
 <div className="mb-2 px-3 text-[10px] font-bold text-theme-text-sec dark:text-[#A1A1AA] uppercase tracking-widest hidden md:block">Modules</div>
 ...
 isActive 
 ? "text-blue-700 "
 : "text-theme-text-sec dark:text-[#A1A1AA] hover:text-theme-text dark:hover:text-slate-100 dark:hover:text-white"
}`}
 title={link.name}
 >
 {isActive && (
 ...
 className="absolute inset-0 bg-blue-50 dark:bg-blue-900/20 dark:bg-theme-card/5 border border-blue-100 dark:border-theme-border/10 rounded-xl"
 initial={false}
 ...
 <div className="mt-8 mb-2 px-3 text-[10px] font-bold text-theme-text-sec dark:text-[#A1A1AA] uppercase tracking-widest hidden md:block">System</div>
 ...
 {/* User Mini Profile */}
 <div className="p-4 border-t border-theme-border dark:border-[#27272A]/50 bg-theme-surface dark:bg-black/20">
 ...
 <p className="text-sm font-bold text-theme-text truncate">{user?.name ||'Loading...'}</p>
