...
const GlobalChatbot = () => {
 ...
 className="bg-theme-card backdrop-blur-3xl border border-theme-border shadow-[0_20px_60px_-15px_rgba(0,0,0,0.15)] dark:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] rounded-[32px] flex flex-col relative overflow-visible mb-6 w-[calc(100vw-3rem)] sm:w-[360px] h-[520px] max-h-[75vh]"
 >
 ...
 {/* Header */}
 <div className="px-5 py-4 flex items-center justify-between border-b border-theme-border relative z-10 bg-theme-card backdrop-blur-md rounded-t-[32px]">
 ...
 <div className="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-emerald-500 border-2 border-theme-border rounded-full"></div>
 </div>
 <div className="flex flex-col">
 <div className="flex items-center gap-1.5">
 <h3 className="font-bold text-theme-text text-sm tracking-tight">AI Assistant</h3>
 {isTyping ? (
 ...
 <p className="text-[11px] text-theme-text-sec font-medium tracking-wide">IncidentIQ Copilot &bull; {pageContext}</p>
 </div>
 </div>
 <button 
 onClick={() => setIsOpen(false)}
 className="p-1.5 text-theme-text-sec hover:text-theme-text-sec dark:hover:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700/50 dark:hover:bg-slate-800/50 rounded-xl transition-colors"
 >
 <X className="h-5 w-5"/>
 </button>
 </div>
 ...
 :'bg-theme-card border border-theme-border text-theme-text rounded-bl-sm shadow-slate-200/50 dark:shadow-none'
}`}>
 {msg.text}
 </div>
 </motion.div>
 ...
 className="px-3 py-1.5 bg-theme-card border border-theme-border hover:border-blue-300 hover:bg-blue-50/80 dark:hover:bg-blue-900/40 text-theme-text-sec hover:text-blue-600 text-[11px] font-semibold rounded-full shadow-sm transition-all"
 >
 {action}
 </button>
 ))}
 ...
 <div className="bg-theme-card border border-theme-border text-theme-text-sec rounded-2xl rounded-bl-sm px-4 py-3.5 shadow-sm dark:shadow-none flex items-center gap-1 h-[46px]">
 ...
 {/* Input Area */}
 <div className="p-4 bg-theme-card backdrop-blur-xl border-t border-theme-border relative z-10 shrink-0 rounded-b-[32px]">
 ...
 className="w-full pl-4 pr-12 py-3 bg-theme-card backdrop-blur-md border border-theme-border rounded-[20px] text-[13.5px] text-theme-text placeholder:text-theme-text-sec focus:outline-none focus:ring-[3px] focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-sm"
 />
 <button 
 type="submit"
 ...
 className="w-16 h-16 rounded-full flex items-center justify-center transition-all relative group z-50 bg-theme-card backdrop-blur-xl border border-theme-border shadow-[0_8px_32px_rgba(37,99,235,0.4)] before:absolute before:inset-0 before:bg-gradient-to-br before:from-blue-600 before:to-purple-600 before:rounded-full before:-z-10"
 >
